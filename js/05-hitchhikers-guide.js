let playGame = prompt('Are you ready to play the game? Yes/No')
if (playGame == 'Yes') {
...
let gameRate = parseInt(prompt('Please, rate the game between 1 and 10.'))


    if (gameRate >= 1 && gameRate <= 5) alert('Thank you! I am working hard to improve the game')

    if (gameRate >= 6 && gameRate <= 10) alert('Thank you! Play again!')

} else document.write("<h2> Ok! Let's play later!")
